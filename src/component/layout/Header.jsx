    ...
    <div>
        <nav className='flex justify-between w-f py-3 p-32 shadow-lg '>
          <img className="w-[150px]" src="	https://fatoura.work/assets/images/Fatoura-Logo-Dark.png" alt="" />
            ...
            <div className='gap-4'>
            <button className='font-bold m-2 border border-slate-300 p-2 w-24 rounded'><Link to='/signup'> Sign In</Link></button>
            <button className='font-bold m-2 border border-slate-300 p-2 w-24 rounded'><Link to='/signup'> Sign Up</Link></button>
